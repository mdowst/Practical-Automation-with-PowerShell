...
# Get the current web object. Will be used to determine URL and time zone ID
...
do {
    try {
        ...
        # If error ID does not match the expected on for the site not being there, set the Status to Problem and throw a terminating error
...
# Set all the parameter values and create the new site
$PnPTenantSite = @{
